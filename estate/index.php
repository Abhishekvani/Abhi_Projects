...
<!DOCTYPE html>
	...
	<title>Property-vila | Home Page |</title>
		...
		<div class="container">
			<div class="row">
				<div class="header-inner">
					<h1><a href="index.php">Property-Vila<span>.</span></a></h1>
					<nav role="navigation">
						<ul>
							...
							<li class="call"><a href="tel://1800 000 1234"><i class="icon-phone"></i> 1800 000 1234</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
					<h2>!-- Top Properties to Sell/Rent --!</p>
				</div>
			<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						<figure>
							...
							<a href="rent.php" class="tag">For Rent</a>
						</figure>
			...
			<div class="row">
				...
				<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-agent">
						<figure>
							<img src="images/agent.jpeg" alt="Free Website Template by FreeHTML5.co">
						</figure>
						<h3>John Doe</h3>
	...
	<footer id="fh5co-footer" role="contentinfo">
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
				<h3>About Us</h3>
				<p>Passionate about simplifying property decisions, propertyvila.com offers home seekers, sellers very real estate professionals an extensive online real estate ecosystem. This ecosystem innovatively combines at a single stop:
					...
					Apartment community management tools.</p>
			</div>	
		</div>
	</footer>
	</div>
